...
describe "LogConverter" do
  before do
    ...
    Pidgin2Adium::LogConverter.stubs(:puts => nil, :log => nil)
  end
  ...
  #   Pidgin2Adium.stubs(:log)
  #   @converter.start()
  #   Pidgin2Adium.should have_received(:log).with(regexp_matches(/Converted 2 files of 3 total/))
  # end
  ...
  #   Pidgin2Adium.stubs(:log)
  #   @converter.start()
  #   Pidgin2Adium.should have_received(:log).with(regexp_matches(/Converted 0 files of 3 total/))
  # end
